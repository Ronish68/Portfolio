...
const contactPage = () => {
    ...
    return (
        <>
            <Nav />
            <div className=" contactMe flex flex-col md:flex-row mb-30 textSlideUp">
                <div className='md:w-1/2 pt-32 m-10'>
                    <h1 className='textSlideUp uppercase text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-bold ' >Let's make something
                ...
                <div className="formArea md:w-1/2 md:pt-38 mr-10">
                    <form action="">
