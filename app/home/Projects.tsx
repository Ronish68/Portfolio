...
const ProjectsSection = () => {
    ...
    useEffect(() => {
        if (!isMounted) return;
        const projectgrids = document.querySelectorAll(".projectgrid");
        ...
        <>
            <section className='projects-section'>
                <div className="works">
                    ...
                    <div className="projectgrid projectgrid1 flex flex-col lg:flex-row my-20 lg:pr-20 ">
                    ...
                    <div className="projectgrid projectgrid2 flex flex-col lg:flex-row my-20 lg:pr-20 ">
