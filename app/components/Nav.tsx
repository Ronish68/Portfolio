...
const Nav = () => {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full flex justify-between items-center px-10 py-6 z-20">

        <div className='logo'>
          <Link href="/" className="text-white text-3xl font-bold tracking-wide bg-zinc-900 rounded">
            RONISH
          </Link>
        </div>
